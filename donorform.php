...
if (isset($_POST['senddetails'])) {
    ...
    $posdate = $_POST['posidate'];
    $negdate = $_POST['negdate'];
    $now = date("d-m-Y");
    $diff = strtotime($negdate) - strtotime($now);
    $days = abs(round($diff / 86400));


    $diff = strtotime($dob) - strtotime($now);
    $days = abs(round($diff / 86400));
    $age = $days / 365;
    $sql = "INSERT into donortable(patientname,bloodgroup,dateofbirth,gender,stateloc,city,Contact,positivedate,negativedate,dayssinceneg,age) VALUES('$patientname','$bg','$dob','$gender','$state','$city','$contact','$posdate','$negdate','$days','$age')";
    ...
    <form action="donorform.php" method="post" enctype="multipart/form-data">
        ...
        <div class="contentform">
            ...
            <div class="rightcontact">
                ...
                <div class="form-group">
                    <p>Date when tested positive:<span>*</span></p>
                    <input type="date" id="posdate" name="posidate" required>
                    <div class="validation"></div>
                </div>
                <div class="form-group">
                    <p>Date when tested negative <span>*</span></p>
                    <input type="date" id="negdate" name="negdate" required>
                    <div class="validation"></div>
                </div>
            </div>
        </div>
